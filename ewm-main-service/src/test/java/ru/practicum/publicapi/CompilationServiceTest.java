...
public class CompilationServiceTest {
    ...
    public void getAll_whenSuccessful_thenReturnCompilationDto() {
        ...
        when(compilationMapper.convertCompilation(compilation1, List.of(eventShortDto1))).thenReturn(compilationDto1);
        when(compilationMapper.convertCompilation(compilation2, List.of(eventShortDto2))).thenReturn(compilationDto2);
        when(eventUtilService.getHitsByEvent(List.of(event1.getId())))
                .thenReturn(hitsByEvent);
        when(eventUtilService.getHitsByEvent(List.of(event2.getId())))
                .thenReturn(hitsByEvent);
