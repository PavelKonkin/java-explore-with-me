...
CREATE TABLE IF NOT EXISTS event_user_rating
(
    event_user_rating_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    event_id BIGINT  NOT NULL,
    user_id  BIGINT  NOT NULL,
    liked    BOOLEAN NOT NULL,
    CONSTRAINT uq_event_user_rating UNIQUE (event_id, user_id),
    CONSTRAINT pk_event_user_rating PRIMARY KEY (event_user_rating_id),
    CONSTRAINT event_user_rating_event_id_fk
        FOREIGN KEY (event_id) REFERENCES events (event_id)
            ON DELETE CASCADE,
    CONSTRAINT event_user_rating_user_id_fk
