...
@RestController(value = "adminCompilationController")
...
public class CompilationController {
    ...
    @Autowired
    public CompilationController(@Qualifier(value = "adminCompilationService") CompilationService compilationService) {
