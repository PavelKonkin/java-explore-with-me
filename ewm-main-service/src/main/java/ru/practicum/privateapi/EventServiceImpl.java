...
@Service(value = "privateEventService")
public class EventServiceImpl implements EventService {
    ...
    public EventFullDto add(long userId, NewEventDto newEventDto) {
        ...
        return eventMapper.convertEventToFullDto(event, 0, 0L);
    }
    ...
    private EventFullDto getEventFullDto(Event event) {
        ...
        return eventMapper.convertEventToFullDto(copyOfEvent, views, confirmedRequestsCount);
    }
